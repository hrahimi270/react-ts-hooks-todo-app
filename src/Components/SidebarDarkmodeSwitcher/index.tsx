...
import { ThemeDispatcherContext, ThemeContext } from '../../Context/ThemeContext'
...
export default function SidebarDarkmodeSwitcher() {
    ...
    const buttonsClassnames = classnames('flex self-center items-center py-2 px-3 text-xs rounded-lg mb-4 focus:outline-none', {
        'bg-gray-800': !isDark,
